...
namespace Infrastructure\Context\ReferenceBooks\ReferenceBook\Repositories\Queries\Sql\ReferenceBookCreationDraft\DataMappers;
...
use Infrastructure\Context\ReferenceBooks\ReferenceBook\Repositories\Queries\Sql\ReferenceBookCreationDraft\GetLockByReferenceBookCreationDraftIdQuery;
...
class MapReferenceBookCreationDraftFromDBStructure
{
    ...
    public static function run(
        ...
        $lock = GetLockByReferenceBookCreationDraftIdQuery::run(new Id($rawReferenceBookCreationDraft->id));
